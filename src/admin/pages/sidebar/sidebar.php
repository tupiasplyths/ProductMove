<div class="sidebar">
        <a href="index.php" class="active"> Trang chủ </a></li>
        <a href="index.php?action=quanly&id=0&query=them"> Quản lý danh mục sản phẩm </a></li>
        <a href="index.php?action=quanlysanpham&id=1&query=them"> Quản lý sản phẩm </a></li>
